...
✅ Eko-generated/owned **illustrative** imagery · textures · backgrounds · mesh/gradient/noise assets we made.
...
## Structure
```
/backgrounds   hero / section / card backgrounds
/textures      noise, grain, mesh, gradient fields
/illustrative  generic illustrative renders (never client-real)
manifest.json  provenance ledger for every file
```
